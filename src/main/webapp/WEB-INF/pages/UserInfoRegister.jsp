...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <select class="SELECT" name="birthdayYear" style="width: 80px" required>
                ...
                <select class="SELECT" name="birthdayMonth" style="width: 50px" required>
                    <option value=""></option>
                ...
                <select class="SELECT" name="birthdayDay" style="width: 50px" required>
                    <option value=""></option>
        ...
        <div class="row">
            ...
            <div class="col-8">
                <input class="TEXTBOX" type="text" name="tel1" style="width: 60px" required data-type="numeric" minlength="2" maxlength="4"> -
                <input class="TEXTBOX" type="text" name="tel2" style="width: 120px" required data-type="numeric" minlength="3" maxlength="4"> -
                <input class="TEXTBOX" type="text" name="tel3" style="width: 120px" required data-type="numeric" minlength="4" maxlength="4">
            </div>
        </div>
        <div class="row">
            <div class="col-1"></div>
            ...
            <div class="col-8">
                <input class="TEXTBOX" type="text" name="postcode1" style="width: 70px" required data-type="numeric" minlength="3" maxlength="3"> -
                <input class="TEXTBOX" type="text" name="postcode2" style="width: 120px" required data-type="numeric" minlength="4" maxlength="4">
            </div>
        </div>
        <div class="row">
            <div class="col-1"></div>
        ...
        <div class="row">
            ...
            <div class="col-8">
                <select class="SELECT" name="hireYear" style="width: 80px" required>
                    <option selected=""></option>
                    <option value="1924">1924年</option>
                    <option value="1925">1925年</option>
                    <option value="1926">1926年</option>
                ...
                <select class="SELECT" name="hireMonth" style="width: 50px" required>
                    <option value=""></option>
                    <option value="1">1月</option>
                    <option value="2">2月</option>
                    <option value="3">3月</option>
                ...
                <select class="SELECT" name="hireDay" style="width: 50px" required>
                    <option value=""></option>
                    <option value="1">1日</option>
                    <option value="2">2日</option>
                    <option value="3">3日</option>
  ...
  <script>
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: '/OfficeSystem_Hibernate11/UserInfoRegistration',
