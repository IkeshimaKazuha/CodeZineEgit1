...
<body>
	<div class="TopContainer">
		...
		<div id="top" class="TopMenu PageHeader">
			<div class="TopMenuTitle">書類申請</div>
		...
		<div class="container1">
			...
			<form method="post" action="ApplicationManage" id="Form1">
				<div class="row div1">
					...
					<select class="col-xs-2 option select1" id="cbx状態"
						name="applyStatus">
					...
					</select> <input type="button" class="col-xs-offset-3 col-xs-3 button"value="新規申請" id="btn新規申請" />
				</div>
			</form>
		</div>
		<div id="container">
